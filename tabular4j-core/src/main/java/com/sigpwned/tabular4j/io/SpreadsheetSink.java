...
public class SpreadsheetSink {
  private final ByteSink bytes;
  private final String fileExtension;
  private final MimeType mimeType;

  public SpreadsheetSink(ByteSink bytes, String fileExtension, MimeType mimeType) {
    this.bytes = requireNonNull(bytes);
    this.fileExtension = requireNonNull(fileExtension);
    this.mimeType = mimeType;
  }

  public ByteSink getBytes() {
    return bytes;
  }
