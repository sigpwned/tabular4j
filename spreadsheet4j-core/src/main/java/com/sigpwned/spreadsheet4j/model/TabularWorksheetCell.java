...
public class TabularWorksheetCell implements WorksheetCell {
  ...
  /**
   * @return
   * @see com.sigpwned.spreadsheet4j.model.WorksheetCell#getColumnIndex()
   */
   ...
   * @param type
   * @return
   * @see com.sigpwned.spreadsheet4j.model.WorksheetCell#getValue(java.lang.reflect.Type)
   */
   ...
   * @param klass
   * @return
   * @see com.sigpwned.spreadsheet4j.model.WorksheetCell#getValue(java.lang.Class)
   */
   ...
   * @param genericType
   * @return
   * @see com.sigpwned.spreadsheet4j.model.WorksheetCell#getValue(com.sigpwned.spreadsheet4j.type.GenericType)
   */
   ...
   * @param qualifiedType
   * @return
   * @see com.sigpwned.spreadsheet4j.model.WorksheetCell#getValue(com.sigpwned.spreadsheet4j.type.QualifiedType)
   */
